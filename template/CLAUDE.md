...
슬라이드를 만들거나 고칠 때는 **반드시 [DESIGN.md](./DESIGN.md) 를 먼저 읽으세요**.

핵심 원칙 세 줄:
1. 사진 크게, 글자 크게, 텍스트 조금
2. 회색 배경 카드 (`var(--bg-elev)` 채움) 반복 금지
3. 카드는 진짜 필요할 때만 (터미널 목업 · 프롬프트 박스 · 시나리오 4장 정도)

좋은 예시: `week2/index.html` 슬 9, 10, 11.
